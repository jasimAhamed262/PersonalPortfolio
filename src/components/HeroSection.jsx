      ...
      <div className="relative container mx-auto px-6 text-center" style={{ zIndex: 10 }}>
        <div className="max-w-4xl mx-auto">
          <h1 className="hero-headline text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            Hi, I'm <span className="neon-text">Jasim</span>
            <br />
            <span className="text-foreground/90">Web Developer &</span>
            <br />
            <span className="bg-gradient-accent bg-clip-text text-transparent">Cloud Enthusiast</span>
          </h1>

          <p className="hero-subtitle text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
            Blending creativity with code to build responsive web experiences and automate cloud operations turning
